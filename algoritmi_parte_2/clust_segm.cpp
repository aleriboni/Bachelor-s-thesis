// see: http://pointclouds.org/documentation/tutorials/cluster_extraction.php#cluster-extraction
...
{
  //std::cout << "stampa input: " << input <<std::endl;
  ...
  //ora uso cloud
  //std::cout << "stampa temp: " << cloud->points[41].x <<std::endl;
//------------------------
...
main (int argc, char** argv)
{
  ...
  pub = nh.advertise<pcl::PCLPointCloud2> ("/output_cluster", 1);
