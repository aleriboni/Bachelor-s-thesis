...
// Calcola la risoluzione spaziale per una PointCloud data facendo la media della
// distanza tra ogni punto e il suo più vicino
double
...
main (int argc, char *argv[])
{
  ...
  //
  //  Caricamento del modello e della scena
  //
  ...
  //
  //  Se l'utente utilizza il flag -r il programma aggiusta i raggi che verranno utilizzati
  //  nella sezione successiva, moltiplicandoli per la risoluzione del modello stimata
  //
  ...
  //
  //  Calcolo delle normali di ogni punto
  //
  ...
  for (size_t i = 0; i < scene_descriptors->size (); ++i)
  {
    ...
    // parametro neigh_sqr_dists[0] modificato rispettoa quello di partenza (0,25f)
    if(found_neighs == 1 && neigh_sqr_dists[0] < 0.02f) //  add match only if the squared descriptor distance is less than 0.25 (SHOT descriptor distances are between 0 and 1 by design)
    {
